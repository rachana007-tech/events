...
urlpatterns = [
    ...
    path('events/',views.fetch_events,name='events'),
    path('hosts/',views.fetch_hosts,name='hosts'),
    path('eventshosts/',views.fetch_eventshosts,name='eventshosts'),
    path('registrations/',views.fetch_registrations,name='register'),
    path('add_event/',views.add_event,name='add'),
    path('update_event/',views.update_event,name='update'),
    path('delete_event/',views.delete_event,name='delete'),
    path('update_host/',views.update_host,name='update'),
